                ...
                <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light bg-white border-bottom border-bottom-lg-0 border-end-lg" id="navbarVertical">
                    <div class="container-fluid">
                        ...
                        <a class="navbar-brand py-lg-2 mb-lg-5 px-lg-6 me-0" href="#">
                            <h3 style={{color:"#DC3545" }}>My Spain Coach</h3>
                        </a>
                        {/* <!-- User menu (mobile) --> */}
                        ...
                        <div class="collapse navbar-collapse" id="sidebarCollapse">
                            {/* <!-- Navigation --> */}
                            <ul class="navbar-nav">
                                <Link to='/superadmin'><li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <i class="bi bi-house"></i> Dashboard
                                    </a>
                                </li></Link>
                                <Link to="/overview"><li class="nav-item">
                                    <a class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <i class="bi bi-chat"></i> Subscribers
                                        <span class="badge bg-soft-primary text-primary rounded-pill d-inline-flex align-items-center ms-auto">6</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <i class="bi bi-bookmarks"></i>  Active Users
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <i class="bi bi-people"></i> Revenue
                                    </a>
                                </li>
                            </ul>
                            {/* <!-- Divider --> */}
